...
function App(props) {
  ...
  useEffect(() => {
    const updateYourCollectibles = async () => {
      ...
      try {
        const totalSupply = await readContracts.YourCollectible.totalSupply();
        setAvailableNFT(10 - totalSupply);
      } catch (e) {
        console.log(e);
      }
    };
  ...
  */
  ...
  const [payment, setPayment] = useState(0.5);
  ...
  return (
    <div className="App">
      ...
      <BrowserRouter>
        ...
        <Switch>
          <Route exact path="/">
            <div style={{ fontSize: 24, marginTop: 32, fontWeight: "bold" }}>
              NFTs Available: {availableNFT} out of 10
            </div>
            <div style={{ marginBottom: "20px" }}>
              <b>NOTE:</b> With every NFT minted the nose shrinks by 10%
            </div>
              ...
              {isSigner ? (
                availableNFT == 0 ? (
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                    <Button type={"primary"} style={{ maxWidth: "180px" }} disabled>
                      All NFTs Minted!
                    </Button>
                  </div>
                ) : (
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                    <Input
                      ...
                      value={payment}
                      style={{ marginBottom: "10px", maxWidth: "30%" }}
                    />
                    <div style={{ marginBottom: "20px" }}>Minimum of 0.5 Matic needs to be paid for minting!</div>
                    <Button
                      type={"primary"}
                      onClick={() => {
                        tx(
            ...
            <div style={{ width: 820, margin: "auto", paddingBottom: 80 }}>
              <List
                bordered
                  ...
                  return (
                    <List.Item key={id + "_" + item.uri + "_" + item.owner}>
                      ...
                      >
                        ...
                        <div style={{ marginBottom: "14px", fontWeight: "bold", fontSize: 24 }}>
                          Nose Length: {item.attributes[0].value}
                        </div>
            ...
            <div style={{ maxWidth: 820, margin: "auto", paddingBottom: 34 }}>
              🛠 built with{" "}
